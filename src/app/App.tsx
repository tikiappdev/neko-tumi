...
export function App() {
  ...
  const game = useGame(player.unlockedCatIds, player.bestScore, completeGame)
  ...
  return <TitleScreen best={best} soundEnabled={player.soundEnabled} onToggleSound={toggleSound} onStart={start} onHowTo={() => setScreen('howto')} featuredCat={(player.unlockedCatIds.at(-1) ?? 'white') as CatKind} />
}
